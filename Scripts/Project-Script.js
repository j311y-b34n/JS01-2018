//variables
a, aa, aaa, aaaa, aaaaa, aaaaaa, aaaaab, aaaaba, aaaabb, aaaac, aaaaca, aaaacb, aaaad, aaaada, aaaadb, aaaab, aaaba, aaabb, aaabba, aaabbb, aab, aaba, aabb, aabba, aabbaa, aabbab, aabbb, aabbba, aabc, ab, aba, abaa, abab, ababa, ababaa, ababab, ababb = prompt
let prompt = (
  ...
  let aaaa="On the first page is a list of strange words. (say 'meza', say 'fycaz', say 'yez', say 'ayzph')",
  let aaaaa="A fire lights on the palm of your dominant hand. (pat it out, watch it)",
  let aaaaaa="It goes out, and only afterwards you realize that it wasn't painful. However, the temporary fire burnt the entire book to ash. You're stuck, permanently. (l)",
  let aaaaab="You watch the fire grow in your hand, not burning you at all. Then it shoots upwards, seemingly of its own accord. It burns a hole through the ceiling and wraps around your wrist. It drags you upwards, and in a torrent of fire you end up on grass, a smoking hole behind you. You smile, the book still in your hand. You set off, learning magic as you go. (w)"
  let aaaab="Water begins to leak off your hands, and after a few moments it seems like the room will flood. (clap, let it go)",
  let aaaaba="The water stops, but the book had all of its ink washed away. You're well and truly stuck. (l)",
  let aaaabb="The water keeps flowing, and suddenly a massive snake head made of water forms out of a wave. It slams itself into the ceiling, then gently lifts you onto a field of grass. The snake shrinks into the size of a grass snake and slithers onto your wrist. Somehow, in the flood, the book survived, and you journey off to explore this land and learn more magic. (w)",
  ...
  let aaaaca="You fall to the ground, landing hard. You can see the book on a rafter far above, ripped out of your hands in the chaos, unreachable. You are completely stuck. (l)",
  let aaaacb="You allow the ceiling to be ripped apart above you, and you're lifted up and land gently in a field of grass. The magic book lands beside you, and you pick it up smiling. (w)",
  ...
  let aaaada="All of the movement stops. The magic book was buried under the spire, and you can see no way our of here. (l)",
  let aaaadb="You rocket through a quickly-growing hole, and you end up in a field full of grass. The book comes flying out of the hole behind you, almost hitting you in the head. You smile and pick it up, walking off to explore and learn. (w)",
  ...
  let aaaba="The ruby melts in your hands, and it somehow becomes acid. 'I told you not to touch it,' the voice says. (l)",
  ...
  let aaabba="He has you read the book you ignored when you came in, and eventually you figure out the language of magic. You stay there for a long time, and when you decide you want to leave, you leave changed. The king crumbles to dust behind you, a smile on his face. (w)",
  let aaabbb="'Fine,' he says. 'But I will not let any of my enemies have you.' He sighs. 'There are three of us, and you are the fated hero that will set one of us free. For me, that is finally being able to leave this world.' He begins chanting. 'Basm yez, basm zabebc, basm yez...' He disappears, leaving you trapped. (l)",
  ...
  let aaba="You ball your fist, but the person slits your throat (l)",
  ...
  let aabbaa="You see a trapdoor in the ceiling, and lunge towards it. The sword goes through the rope hanging down, and the door snaps open. You climb, and eventually make it into the surface. You leave the sword there, in the grassy field, and you see a dark shadow in the trees far away, like the person who met you there. (w)",
  let aabbab="you yell, but the water overtakes you. You end up drowning, barely able to scream as the water takes you. (l)",
  let aabbb="You turn to leave, but the door is locked. when you turn around, the person is there, dressed in all black. The sword is gone. (demand sword, demand to leave)",
  let aabbba="The person chuckles and moves so quickly they seem to disappear. They leave you in that room, where you're trapped (l)",
  let aabc="'This place is full of magic, and I am one of the three denziens of it. One sect loves magic, one runs from it, and mine avoids it.' they lead you into the room, and continue explaining (let them continue)",
  ...
  let aba="You go upstairs to hear a roar of water below you. The purple door blasted open and is spilling saltwater in massive quantities into the hallway. You look around and see massive amounts of treasure. the ghost says not to even brush up against any of it, and that the exit to the building is on the top floor. The door to the stairs is behind a massive pile of gold. (steal treasure, move treasure from in front of door, try to force door open)",
  let abaa="The treasure rises and forms into a dragon as soon as you touch it, and it breathes fire onto you as soon as it sees you. (l)",
  ...
  let ababaa="You try to pick the lock with a paperclip in your pocket, but the flames catch up. You manage to hear the spirit saying 'Unbeliever' disdainfully before the fire overwhelms you. (l)",
  ...
  let ababb="you raise your fists, and a wave of flame engulfs you. (l)"
)
//jquery display
$("#go").click(() => {
